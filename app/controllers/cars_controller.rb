class CarsController < ApplicationController
  ...
  def programm_create
    ...
    FileUtils.mkdir_p "F://BAZA/#{@brand_ecu}/#{@model_ecu}/#{@model}/#{@soft_ecu}/#{@sw_ident}/#{@licence.upcase}"
    ...
    @id_client = File.new("F://BAZA/#{@brand_ecu}/#{@model_ecu}/#{@model}/#{@soft_ecu}/#{@sw_ident}/#{@licence.upcase}/#{@licence.upcase}.html", 'a+')
